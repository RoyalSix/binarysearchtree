...
class Tree
{
   public:
	 //***********************************************************
	 // Below are 4 new member functions to implement
	 //***********************************************************
	 ...
	 int FindHeightOfSubtree(TreeNode * SubtreeRoot);					
...
private:
	 ...
	 float TotalOfTree(TreeNode* SubtreeRoot);

	 float FindSizeOfTree(TreeNode* SubtreeRoot);

	 int FindMaximumOfTree(TreeNode* SubtreeRoot);

	 float FindAverageOfTree(TreeNode* SubtreeRoot);
